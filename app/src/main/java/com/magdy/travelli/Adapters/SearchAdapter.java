...
public class SearchAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){
            ...
            recentDrawable = mContext.getResources().getDrawable(R.drawable.ic_settings_backup_restore_black_24dp, null);

        } else {
            searchDrawable = mContext.getResources().getDrawable(R.drawable.ic_magnify_grey600_24dp);
            recentDrawable = mContext.getResources().getDrawable(R.drawable.ic_settings_backup_restore_black_24dp);
        }
        if(mIsFilterList) {
